...
CREATE TABLE [dbo].[Igra] (
    ...
    CONSTRAINT [igra_pk] PRIMARY KEY CLUSTERED ([klub_naziv] ASC, [igrac_id_igraca] ASC)
);
...
CREATE TABLE [dbo].[Igrac] (
    ...
    [vodi_id_trenera] INT          NOT NULL,
    [vodi_naziv]      VARCHAR (30) NOT NULL,
...
GO
PRINT N'Creating [dbo].[igra_klub_fk]...';


GO
ALTER TABLE [dbo].[Igra] WITH NOCHECK
    ADD CONSTRAINT [igra_klub_fk] FOREIGN KEY ([klub_naziv]) REFERENCES [dbo].[Klub] ([naziv]);


GO
PRINT N'Creating [dbo].[igra_igrac_fk]...';


GO
ALTER TABLE [dbo].[Igra] WITH NOCHECK
    ADD CONSTRAINT [igra_igrac_fk] FOREIGN KEY ([igrac_id_igraca]) REFERENCES [dbo].[Igrac] ([id_igraca]);
...
GO
ALTER TABLE [dbo].[Igra] WITH CHECK CHECK CONSTRAINT [igra_klub_fk];

ALTER TABLE [dbo].[Igra] WITH CHECK CHECK CONSTRAINT [igra_igrac_fk];
