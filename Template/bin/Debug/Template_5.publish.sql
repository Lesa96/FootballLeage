...
CREATE TRIGGER [DeleteTriger]
	...
	END
GO
PRINT N'Altering [dbo].[Prosek]...';


GO
ALTER FUNCTION [dbo].[Prosek]
(
	@param1 int,
	@param2 int
)
...
END
GO
PRINT N'Altering [dbo].[SumProcedura]...';


GO
ALTER PROCEDURE [dbo].[SumProcedura]
	
AS
	SELECT ime_trenera FROM Trener,Vodi WHERE Trener.id_trenera = Vodi.trener_id_trenera
GO
